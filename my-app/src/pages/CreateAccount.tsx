...
export default function RegisterUser() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const res = await axios.post(`${getApiUrl()}users`, payload);

      setSuccess(true);

      if (formData.type === "teacher") {
        await axios.post(`${getApiUrl()}teachers`, {
          user_id: res.data.id,
  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm text-center">
        <img
          src="https://raw.githubusercontent.com/OnurbGo/Curso_Arte_Da_Guerra/main/my-app/src/assets/Yin_and_Yang_symbol.png"
          alt="Arte da Guerra"
